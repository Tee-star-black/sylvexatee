...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: "Sylvexa web development and custom software in Johannesburg, Gauteng - soon to be trading as Bohlal-itech",
    }],
  },
  twitter: {
...
const websiteSchema = {
  ...
  url: siteConfig.url,
  name: siteConfig.name,
  alternateName: "Sylvexa South Africa",
    ...
    >
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([organizationSchema, websiteSchema, serviceSchema]).replace(/</g, "\\u003c"),
        }}
      />
    </html>
  );
