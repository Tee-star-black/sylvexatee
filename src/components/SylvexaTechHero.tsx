...
export default function SylvexaTechHero() {
  return (
    ...
    >
      ...
      <div className={officeStyles.assetScatter} aria-hidden="true">
        <span className={`${officeStyles.asset} ${officeStyles.assetOne}`} />
        <span className={`${officeStyles.asset} ${officeStyles.assetTwo}`} />
        <span className={`${officeStyles.asset} ${officeStyles.assetThree}`} />
      </div>
